...
final class Version20240508193639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(
            <<<'SQL'
                CREATE TABLE menu_item_page (
                    ...
                    CONSTRAINT FK_C57A95EFC4663E4 FOREIGN KEY (page_id) REFERENCES page (id),
        ...
        $this->addSql(
            <<<'SQL'
                UPDATE menu_item SET discriminator = 'menu' WHERE discriminator IS NULL
            SQL,
        );
    }
}
